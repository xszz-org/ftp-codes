...
function up() {
  ...
  echo "远程上传是什么意思？<br>远程上传是从其他服务器获取文件并直接下载到当前服务器的一种功能。<br>类似于SSH的Wget功能，免去我们下载再手动上传所浪费的时间。<br><br>远程下载地址:<form action=\"".$adminfile."?op=yupload\" method=\"POST\"><input name=\"url\" size=\"80\" /><input name=\"submit\" value=\"上传\" type=\"submit\" /></form>\n"
    ."以下为备用下载地址：（请手动复制）"
    ."<br>Wordpress：http://cn.wordpress.org/wordpress-3.4.1-zh_CN.zip"
    ."<br>Discuz(UTF8)：http://download.comsenz.com/DiscuzX/2.5/Discuz_X2.5_SC_UTF8.zip"
    ."<br>Discuz(GBK)：http://download.comsenz.com/DiscuzX/2.5/Discuz_X2.5_SC_GBK.zip";
  mainbottom();
}
